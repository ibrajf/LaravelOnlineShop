...
@section('content')
    ...
    <!-- ********************** start content ********************** -->
        ...
        <!-- start banner -->
        <div class="page-banner" style="background-image: url(frontend/assets/uploads/banner_product_category.jpg)">
            <div class="inner">
            <h1>Category: Men</h1>
            </div>
        </div>
                ...
                <div class="col-md-9">
                    ...
                    <div class="product product-cat">
                        ...
                        <div class="col-md-4 item item-product-cat">
                            <div class="inner">
                                <div class="thumb">
                                    <div class="photo" style="background-image:url(frontend/assets/uploads/product-featured-85.jpg);"></div>
                                    <div class="overlay"></div>
                                </div>
                                <div class="text">
                        ...
                        <div class="col-md-4 item item-product-cat">
                            <div class="inner">
                                <div class="thumb">
                                    <div class="photo" style="background-image:url(frontend/assets/uploads/product-featured-89.jpg);"></div>
                                    <div class="overlay"></div>
                                </div>
                                <div class="text">
                        ...
                        <div class="col-md-4 item item-product-cat">
                            <div class="inner">
                                <div class="thumb">
                                    <div class="photo" style="background-image:url(frontend/assets/uploads/product-featured-83.jpg);"></div>
                                    <div class="overlay"></div>
                                </div>
                                <div class="text">
                        ...
                        <div class="col-md-4 item item-product-cat">
                            <div class="inner">
                                <div class="thumb">
                                    <div class="photo" style="background-image:url(frontend/assets/uploads/product-featured-88.jpg);"></div>
                                    <div class="overlay"></div>
                                </div>
                                <div class="text">
