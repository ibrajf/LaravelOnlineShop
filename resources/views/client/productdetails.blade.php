                       ...
                       <div class="col-md-5">
                          <ul class="prod-slider">
                             <li style="background-image: url({{asset('frontend/assets/uploads/product-featured-86.jpg')}});">
                                <a class="popup" href="frontend/assets/uploads/product-featured-86.jpg"></a>
                             </li>
                             <li style="background-image: url(frontend/assets/uploads/product_photos/112.jpg);">
                                <a class="popup" href="frontend/assets/uploads/product_photos/112.jpg"></a>
                             </li>
                             <li style="background-image: url(frontend/assets/uploads/product_photos/113.jpg);">
                                <a class="popup" href="frontend/assets/uploads/product_photos/113.jpg"></a>
                             </li>
                          </ul>
                          <div id="prod-pager">
